...
Results: Successful response with trivia questions.
...
Results: Successful response with category list.
...
| --- | --- | --- | --- |
| Api | `list` | `GET /api.php` | See reference |
| ApiCategory | `list` | `GET /api_category.php` | See reference |

## Connect to the API

- Open Trivia Database API Server: `https://opentdb.com`
...
- `trivia_list`: List records for an entity. Supported entities: `api`, `api_category`.
- `trivia_load`: Load one record for an entity. No active entity supports this operation.
