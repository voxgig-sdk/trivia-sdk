# Trivia SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TriviaSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TriviaSDK(...) and TriviaSDK.test(...) become
#      TriviaSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "trivia_sdk"
_SDK_CLASS = "TriviaSDK"
