...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/trivia-sdk/releases)) or
...
The main module (`trivia_sdk`) exports the SDK class.
