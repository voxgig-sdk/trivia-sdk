...
from trivia_sdk.trivia_types import (
    ApiCategory,
    ApiCategoryListMatch,
)
...
class ApiCategoryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiCategoryEntity(self._client, opts)
    ...
    def match_get(self) -> ApiCategory:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApiCategory]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApiCategory().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
