...
from trivia_sdk.utility import register

# Load features
from trivia_sdk.feature.base_feature import TriviaBaseFeature
from trivia_sdk.features import _has_feature, _make_feature
...
class TriviaSDK:
    ...
    def get_utility(self):
        return TriviaUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TriviaSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Api(self, data=None) -> "ApiEntity":
        ...
        from trivia_sdk.entity.api_entity import ApiEntity
    ...
    def ApiCategory(self, data=None) -> "ApiCategoryEntity":
        ...
        from trivia_sdk.entity.api_category_entity import ApiCategoryEntity
