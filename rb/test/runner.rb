...
module TriviaTestRunner
  ...
  def self.env_override(m)
    live = getenv("TRIVIA_TEST_LIVE")
    override = getenv("TRIVIA_TEST_OVERRIDE")
    ...
    explain = getenv("TRIVIA_TEST_EXPLAIN")
    m["TRIVIA_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = TriviaTestRunner
Helpers = TriviaHelpers
Vs = VoxgigStruct
