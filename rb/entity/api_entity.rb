...
class ApiEntity
  ...
  #
  # @param reqmatch [ApiListMatch, Hash, nil] match filter (any subset of
  #   Api fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Api>, Array] the matching Api items; raises TriviaError on failure
