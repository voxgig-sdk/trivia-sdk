...
describe('ApiCategoryDirect', async () => {
  ...
  test('direct-list-api_category', async (t: any) => {
    if (liveScenariosActive()) { t.skip('Covered by live operation scenarios'); return }
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-api_category', setup.live)) return
