...
(0, node_test_1.describe)('ApiCategoryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-api_category', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-api_category', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.TRIVIA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TriviaSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['TRIVIA_TEST_API_CATEGORY_ENTID'];
    ...
    const client = new __1.TriviaSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ApiCategoryDirect.test.js.map