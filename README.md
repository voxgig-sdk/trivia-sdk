...
Learn more about Trivia API at [opentdb.com](https://opentdb.com).
...
This SDK exposes the API as a small set of **semantic entities** — Api and ApiCategory — that you
...
const items = await client.Api().list({ amount: 1 })
```
...
| **ApiCategory** | The ApiCategory entity (list). | `/api_category.php` |
