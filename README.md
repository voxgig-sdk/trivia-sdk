...
This is an unofficial SDK for the Trivia public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/trivia` | `npm install @voxgig-sdk/trivia` |
| Python | `voxgig-sdk-trivia` | `pip install voxgig-sdk-trivia` |
| PHP | `voxgig-sdk/trivia` | `composer require voxgig-sdk/trivia` |
| Golang | `github.com/voxgig-sdk/trivia-sdk/go` | `go get github.com/voxgig-sdk/trivia-sdk/go` |
| Ruby | `voxgig-sdk-trivia` | `gem install voxgig-sdk-trivia` |
| Lua | `voxgig-sdk-trivia` | `luarocks install voxgig-sdk-trivia` |
...
- Upstream API: [https://opentdb.com](https://opentdb.com)
