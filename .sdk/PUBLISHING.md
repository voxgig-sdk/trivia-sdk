...
|---|---|---|
| `ts/` | @voxgig-sdk/trivia-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/trivia-sdk \
      --repository voxgig-sdk/trivia-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/trivia-sdk` shows it, and
`npm trust revoke @voxgig-sdk/trivia-sdk --id=<id>` removes it.
