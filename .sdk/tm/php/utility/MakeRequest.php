...
// Trivia SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TriviaMakeRequest
{
    public static function call(TriviaContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TriviaResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TriviaResponse($fetched);
        } else {
