...
class TriviaCacheFeature extends TriviaBaseFeature
{
    ...
    private function _through(TriviaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
