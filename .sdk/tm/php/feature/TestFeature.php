...
// Trivia SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TriviaTestFeature extends TriviaBaseFeature
{
    ...
    public function init(TriviaContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TriviaContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TriviaContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TriviaContext $ctx, $op, $args): array
    {
