...
class TriviaProxyFeature extends TriviaBaseFeature
{
    ...
    public function init(TriviaContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TriviaContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
