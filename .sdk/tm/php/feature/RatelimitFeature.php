...
class TriviaRatelimitFeature extends TriviaBaseFeature
{
    ...
    private function _acquire(TriviaContext $ctx): void
    {
    ...
    private function _track(TriviaContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
