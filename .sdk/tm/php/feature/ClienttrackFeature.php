...
// Trivia SDK clienttrack feature
...
class TriviaClienttrackFeature extends TriviaBaseFeature
{
    ...
    public function PostConstruct(TriviaContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Trivia-SDK';
