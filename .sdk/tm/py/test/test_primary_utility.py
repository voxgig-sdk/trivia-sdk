...
from projectname_sdk import TriviaSDK
from projectname_sdk.core.spec import TriviaSpec
from projectname_sdk.core.result import TriviaResult
from projectname_sdk.core.response import TriviaResponse
from projectname_sdk.core.operation import TriviaOperation
from projectname_sdk.core.error import TriviaError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import TriviaBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = TriviaSDK.test(None, None)
        ...
        class TestInitFeature(TriviaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(TriviaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = TriviaSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = TriviaSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = TriviaSDK.test(None, setup_opts)
