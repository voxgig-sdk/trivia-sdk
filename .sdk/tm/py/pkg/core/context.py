...
from projectname_sdk.core.control import TriviaControl
...
class TriviaContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, TriviaResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TriviaError(code, msg, self)
