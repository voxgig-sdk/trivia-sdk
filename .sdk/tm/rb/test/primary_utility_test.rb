...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = TriviaOmni.make_runner(TEST_JSON_FILE, TriviaSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : TriviaOmni.errify(err)
    end
