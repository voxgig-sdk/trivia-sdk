...
type Args struct {
	Entity string         `json:"entity" jsonschema:"api | api_category"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TriviaSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "trivia_list",
		Description: "List records from Trivia. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "trivia_load",
		Description: "Load a single record from Trivia. " +
...
func runOp(client *sdk.TriviaSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TriviaSDK, name string) (sdk.TriviaEntity, error) {
	switch strings.ToLower(name) {
	case "api":
		return client.Api(nil), nil
	case "api_category":
		return client.ApiCategory(nil), nil
