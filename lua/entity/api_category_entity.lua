...
local ApiCategoryEntity = {}
ApiCategoryEntity.__index = ApiCategoryEntity


function ApiCategoryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApiCategoryEntity)
  self._name = "api_category"
  self._client = client
...
function ApiCategoryEntity:get_name()
  return self._name
end


function ApiCategoryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApiCategoryEntity.new(self._client, opts)
end
...
function ApiCategoryEntity:mark_deleted()
  self._deleted = true
end


function ApiCategoryEntity:deleted()
  return true == self._deleted
end


function ApiCategoryEntity:data_set(args)
  if args ~= nil then
...
function ApiCategoryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApiCategoryEntity:match_set(args)
  if args ~= nil then
...
function ApiCategoryEntity:match_get()
...
function ApiCategoryEntity:stream(action, args, callopts)
...
function ApiCategoryEntity:_run_op(ctx, post_done)
  local utility = self._utility
