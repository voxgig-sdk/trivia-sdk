...
The Lua SDK for the Trivia API — an entity-oriented client using Lua conventions.
...
Create an instance: `local api_category = client:ApiCategory(nil)`
...
```lua
local api_categorys, err = client:ApiCategory():list()
```
...
```
lua/
├── trivia_sdk.lua    -- Main SDK module
...
The main module (`trivia_sdk`) exports the SDK constructor
