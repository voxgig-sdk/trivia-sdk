...
describe("ApiCategoryDirect", function()
  it("should direct-list-api_category", function()
    local setup = api_category_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-api_category", setup.live and "live" or "unit")
...
function api_category_direct_setup(mockres)
