...
func registerSDKWords(r *eng.Registry, client *sdk.TriviaSDK) {
...
func runOp(client *sdk.TriviaSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
