...
class TriviaFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TriviaSDK/1.0)';
    ...
    public static function call(TriviaContext $ctx, string $fullurl, array $fetchdef): array
    {
