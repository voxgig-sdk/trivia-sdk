...
class TriviaStreamingFeature extends TriviaBaseFeature
{
    ...
    private function _iterate(TriviaResult $result): \Generator
    {
    ...
    private function _streamable(TriviaContext $ctx): bool
    {
