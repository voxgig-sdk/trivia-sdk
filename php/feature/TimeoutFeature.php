...
class TriviaTimeoutFeature extends TriviaBaseFeature
{
    ...
    private function _with_timeout(TriviaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TriviaContext $_ctx, float $ms): void
    {
        $client = $this->client;
