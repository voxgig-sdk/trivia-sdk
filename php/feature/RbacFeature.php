...
class TriviaRbacFeature extends TriviaBaseFeature
{
    ...
    private function _required(TriviaContext $ctx): ?string
    {
    ...
    private function _reject(TriviaContext $ctx, string $required): void
    {
    ...
    private function _track(TriviaContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
