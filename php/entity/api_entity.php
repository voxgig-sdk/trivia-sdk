...
class ApiEntity
{
    ...
    /**
     * List Api items matching the given filter.
     *
     * @param ApiListMatch|array|null $reqmatch Match filter (any subset
     *   of Api fields) as an assoc-array; ApiListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Api[]|array A list of Api items as assoc-arrays at
