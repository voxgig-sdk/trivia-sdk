...
class ApiCategoryDirectTest extends TestCase
{
    public function test_direct_list_api_category(): void
    {
        $setup = api_category_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-api_category", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
