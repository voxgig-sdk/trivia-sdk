...
class TriviaTestRunner
{
    ...
    {
        $live = self::getenv('TRIVIA_TEST_LIVE');
        $override = self::getenv('TRIVIA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TRIVIA_TEST_EXPLAIN');
...
class_alias('TriviaTestRunner', 'Runner');
class_alias('TriviaHelpers', 'Helpers');
