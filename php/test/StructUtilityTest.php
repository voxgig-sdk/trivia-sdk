...
// Trivia SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TriviaOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TriviaOmni::structfix($now, Struct::undef()))
                        !== json_encode(TriviaOmni::structfix($val, Struct::undef()))) {
