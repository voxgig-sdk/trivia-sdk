...
// Trivia SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TriviaSDK::test)
...
{
    private const SDK_CLASS = 'TriviaSDK';
    ...
    private const SDK_BASE = 'trivia_sdk';
