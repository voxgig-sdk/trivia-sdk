...
The PHP SDK for the Trivia API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Api(null)->list(null, null);
...
[$result, $err] = $client->Trivia(null)->load(
    ["id" => "test01"], null
);
...
```php
$client = TriviaSDK::test($testopts, $sdkopts);
```
...
The main class (`trivia_sdk.php`) exports the SDK class
