...
func (sdk *TriviaSDK) OptionsMap() map[string]any {
...
func (sdk *TriviaSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TriviaSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TriviaSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TriviaSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TriviaSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TriviaSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TriviaSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TriviaSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TriviaSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TriviaSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
