# Trivia Golang SDK Reference

Complete API reference for the Trivia Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *TriviaSDK`
...
#### `Api(data map[string]any) TriviaEntity`

Create a new `Api` entity instance. Pass `nil` for no initial data.

#### `ApiCategory(data map[string]any) TriviaEntity`
