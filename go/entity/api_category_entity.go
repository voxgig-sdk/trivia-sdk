...
type ApiCategoryEntity struct {
	name    string
	client  *core.TriviaSDK
...
func NewApiCategoryEntity(client *core.TriviaSDK, entopts map[string]any) *ApiCategoryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ApiCategoryEntity) GetName() string { return e.name }
...
func (e *ApiCategoryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ApiCategoryEntity) Deleted() bool {
	return e.deleted
}


func (e *ApiCategoryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewApiCategoryEntity(e.client, opts)
}

func (e *ApiCategoryEntity) Data(args ...any) any {
...
func (e *ApiCategoryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ApiCategory; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ApiCategoryEntity) DataTyped(data ...ApiCategory) ApiCategory {
	if len(data) > 0 {
		return typedFrom[ApiCategory](e.Data(asMap(data[0])))
	}
	return typedFrom[ApiCategory](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ApiCategory (all fields
// optional at the wire level).
func (e *ApiCategoryEntity) MatchTyped(match ...ApiCategory) ApiCategory {
	if len(match) > 0 {
		return typedFrom[ApiCategory](e.Match(asMap(match[0])))
	}
	return typedFrom[ApiCategory](e.Match())
}
...
func (e *ApiCategoryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ApiCategoryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ApiCategoryEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ApiCategoryListMatch and returns []ApiCategory. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ApiCategoryEntity) ListTyped(reqmatch ApiCategoryListMatch, ctrl map[string]any) ([]ApiCategory, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ApiCategory](res), nil
}



func (e *ApiCategoryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ApiCategoryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ApiCategoryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ApiCategoryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
