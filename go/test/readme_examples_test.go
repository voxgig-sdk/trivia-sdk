...
const testSeed = `map[string]any{"entity": map[string]any{"api": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "api_category": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
