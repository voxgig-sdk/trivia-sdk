...
The Golang SDK for the Trivia API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/trivia-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/trivia-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/trivia-sdk/go=../trivia-sdk/go
```
...
```go
func NewTriviaSDK(options map[string]any) *TriviaSDK
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *TriviaSDK
```
...
| `Api` | `(data map[string]any) TriviaEntity` | Create an Api entity instance. |
| `ApiCategory` | `(data map[string]any) TriviaEntity` | Create an ApiCategory entity instance. |

### Entity interface (TriviaEntity)

All entities implement the `TriviaEntity` interface.
...
```
github.com/voxgig-sdk/trivia-sdk/go/
├── trivia.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/trivia-sdk/go`) re-exports everything needed
